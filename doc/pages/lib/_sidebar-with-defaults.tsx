 ...
 */
export function SidebarWithDefaults(props: SidebarWithDefaultsProps): JSX.Element {
  const { currentSlug, lang = defaultLocale, navSection, currentVersion, currentPath = '' } = props;
