...
import { loadCategoryMeta, isNavVisible, type CategoryMeta } from '@/utils/docs';
 ...
 */
export function loadNavSourceDocs(lang: Locale, currentVersion: string | undefined): NavSourceDocs {
