...
export function DocHistoryArea({
  ...
  const docHistoryLocale =
    effectiveHistoryLocale === defaultLocale ? undefined : effectiveHistoryLocale;
  ...
  const docHistoryIsland = Island({
    ...
    children: (
      <DocHistory slug={historySlug} locale={docHistoryLocale} basePath={docHistoryBasePath} />
    ),
  }) as unknown as VNode;
