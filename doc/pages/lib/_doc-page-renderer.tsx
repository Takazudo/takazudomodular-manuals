...
export function renderDocPage(props: DocPageBaseProps, opts: RenderDocPageOptions): JSX.Element {
  ...
  const description =
    props.kind === 'autoIndex' ? props.autoIndex.description : props.entry.data.description;
  ...
  const versionBannerLatestUrl = versionBannerType ? docsUrl(slug, locale) : undefined;
