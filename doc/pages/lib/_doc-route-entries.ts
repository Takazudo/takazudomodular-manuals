...
import { buildNavTree, buildBreadcrumbs, collectAutoIndexNodes, type NavNode } from '@/utils/docs';
 ...
 */
export function buildDocRouteEntries(args: BuildDocRouteEntriesArgs): DocRouteEntry[] {
