 ...
 */
function writeUnlistedSubPage(outputPath: string, title: string, slug: string, body: string) {
  fs.writeFileSync(
    outputPath,
 ...
 */
function assertNotIndexReserved(nameOrSlug: string, errorMessage: string) {
  if (nameOrSlug === 'index') {
