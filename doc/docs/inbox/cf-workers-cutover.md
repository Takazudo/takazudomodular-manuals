...
| Legacy redirect | `https://manuals.takazudomodular.com/manuals/oxi-one-mk2/page/1` | 301 → `/oxi-one-mk2/page/1` (the Worker serves the built-in `/manuals/* → /:splat` redirect) |
