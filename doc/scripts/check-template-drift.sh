...
# Features not scaffolded (e.g. i18n, llmsTxt, docTags, tagGovernance) are
# intentionally absent; their template files would produce spurious
# [MISSING IN PROD] errors if checked.
#
# Feature name -> template directory mapping (enabled features only):
...
for feature in docHistory bodyFootUtil claudeResources imageEnlarge sidebarToggle; do
