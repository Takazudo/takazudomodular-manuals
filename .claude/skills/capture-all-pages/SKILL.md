...
- Dev server running on port 3300 (`pnpm dev`)
...
# Custom base URL
node .claude/skills/capture-all-pages/scripts/capture.js --base-url http://zmanuals.localhost:3300/oxi-one-mk2/page
```
...
- `--base-url <url>` - Base URL for pages (default: http://zmanuals.localhost:3300/oxi-one-mk2/page)
...
1. **Verify dev server is running**
   ...
   ```bash
   curl -s -o /dev/null -w "%{http_code}" http://zmanuals.localhost:3300/oxi-one-mk2/page/1
   # Should return 200
   ```
